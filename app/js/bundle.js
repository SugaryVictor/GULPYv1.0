...
var tabsItems = document.querySelectorAll('.tabs__item'); //Красим активные кнопки

tabsBtn.forEach(onTabClick); //Это наша функция которая всё далает, а выше мы её вязвали, и теперь в случае чего мы можем вызвать жту функцию в любой момент

function onTabClick(item) {
  item.addEventListener('click', function () {
    var currentBtn = item;
    var tabId = currentBtn.getAttribute('data-tab'); //Даёт нам атрибут на который мы нажали

    var currentTab = document.querySelector(tabId); //Тут кнопка на которую мы нажали
